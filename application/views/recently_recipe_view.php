  ...
  <div class="col-md-12 col-xs-12 col-no-padding-right page-header" style="margin-top:5px">
    <div class="col-md-2 col-xs-12 detail-list-img" style="margin-right:2px">
        <a href="<?php echo base_url();?>index.php/recipe/get/{recently_recipe_id}">
          <img class="img-responsive img-rounded details-img-recipe" src="<?php echo base_url();?>{recently_recipe_photo}"/>
        </a>
    </div>
    <div class="col-md-8 col-xs-12 detail-list">
     ...
     <div class="col-md-12 col-xs-6 details col-no-padding">
          <div class="col-md-4 col-xs-6 col-no-padding-right details-user-recipe">
            <a href="<?php echo base_url();?>index.php/user/timeline/{recently_recipe_author_id}"><p class="text-capitalize">{recently_recipe_author_name}</p></a>
          </div>
     ...
     <div class="col-md-12 col-xs-6 details details-rating">
        <div class="col-md-12 col-xs-12" title="Rating">
            <input id="input-2b" class="rating" value="{recently_recipe_rating}" data-recipeId="{recently_recipe_id}" data-readonly='true' data-min="0" data-max="5" data-starts=3 data-step="0.1" data-stars=5 data-symbol="&#xe005;" data-size="xs" data-default-caption="{rating} hearts" data-star-captions="{}" data-show-clear="false">
        </div>
      </div>  
    </div>
  </div>
