<div class="panel-body">
  ...
  <div class="col-md-12 col-xs-12 col-no-padding-right page-header" style="margin-top:5px">
    <div class="col-md-2 col-xs-12 detail-list-img" style="margin-right:2px">
        <a href="<?php echo base_url();?>index.php/recipe/get/{search_by_ingredient_recipe_id}">
          <img class="img-responsive img-rounded img-list-usertimeline" style="margin:auto" src="<?php echo base_url();?>{search_by_ingredient_recipe_photo}"/>
        </a>
    </div>
    <div class="col-md-6 col-xs-12 detail-list">
      ...
      <div class="col-md-12 col-xs-12 details">
          <div class="col-md-5 col-xs-6 text-right">
            <a href="<?php echo base_url();?>index.php/user/timeline/{search_by_ingredient_recipe_author_id}"><p class="text-capitalize">{search_by_ingredient_recipe_author_name}</p></a>
          </div>
          <div class="col-md-7 col-xs-6 text-left" style="border-left:dashed 1px #FFD76B">
            <p class="text-capitalize">{search_by_ingredient_recipe_last_update}</p>
          </div>
      </div>
      <div class="col-md-12 col-xs-12 details">
        <div class="col-md-11" title="Rating">
            <input id="input-2b" class="rating" value="{search_by_ingredient_recipe_rating}" data-readonly='true' data-min="0" data-max="5" data-starts=3 data-step="0.1" data-stars=5 data-symbol="&#xe005;" data-size="xs" data-default-caption="{rating} hearts" data-star-captions="{}" data-show-clear="false">
        </div>
      </div> 
      <div class="col-md-12 col-xs-12 details" style="padding:0 15px">
