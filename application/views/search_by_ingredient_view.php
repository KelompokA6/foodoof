  ...
  <div class="col-md-12 col-xs-12 col-no-padding-right page-header" style="margin-top:5px">
    <div class="col-md-2 col-xs-12 detail-list-img" style="margin-right:2px">
        <a href="<?php echo base_url();?>index.php/recipe/get/{search_by_ingredient_recipe_id}">
          <img class="img-responsive img-rounded details-img-recipe" style="margin:auto" src="<?php echo base_url();?>{search_by_ingredient_recipe_photo}"/>
        </a>
    </div>
    <div class="col-md-8 col-xs-12 detail-list">
      ...
      <div class="col-md-12 col-xs-6 details">
      ...
      <div class="col-md-12 col-xs-12 details" style="padding:15px 15px 0">
