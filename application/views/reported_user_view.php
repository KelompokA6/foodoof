		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="col-md-12 col-xs-12 col-sm-12 border-solid-bottom list-reported" style="padding:5px 0">
					<label class=" col-md-9 col-xs-9 col-sm-3 control-label text-left" title="Reported User">
			      		<input type="checkbox" class="col-md-1 col-xs-1 col-sm-1 checkboxuser" title="Banned" name= 'id_reported[]' value='<?php echo $reported_user_entry["reported_user_id"];?>'>
					...
					<div class='col-md-offset-1 col-md-11 col-xs-11 col-sm-11 details-reported' style='padding:5px 0 5px 2px'>
				        <ul class="list-group">
				        	<?php foreach ($reported_user_entry["reported_recipe_entries"] as $reported_recipe_entries) {?>
				          	<li class="col-md-12 col-sm-12 col-xs-12 col-no-padding border-solid-bottom">
				            	<div class="col-md-4 col-xs-4 col-sm-4 col-no-padding title-recipe" title="<?php echo $reported_recipe_entries["reported_recipe_name"];?>">
