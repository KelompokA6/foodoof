<div class="panel-body">
  ...
  <div class="col-md-12 col-xs-12col-no-padding-right page-header" style="margin-top:5px">
    <div class="col-md-2 col-xs-3 detail-list-img" style="margin-right:2px">
        <a href="<?php echo base_url();?>recipe/get/{search_by_title_recipe_id}">
  ...
  <div class="col-md-12 col-xs-12 text-center">
    <?php
      if($search_by_title_recipe_page_size > 0){
        ...
        echo "'><a href='".base_url()."search/?q=".$search_by_title_recipe_key)."&searchby=title&page=".($search_by_title_recipe_page_now - 1)."' aria-label='Previous'>
        ...
        for ($i=1; $i <= $search_by_title_recipe_page_size ; $i++) { 
          ...
          echo "
            <li class=".$active.">
              <a href='".base_url()."search/?q=".$search_by_title_recipe_key)."&searchby=title&page=".$i."'>".$i."</a>
            </li>
          ";
        }
        ...
        echo "'><a href='".base_url()."search/?q=".$search_by_title_recipe_key)."&searchby=title&page=".($search_by_title_recipe_page_now + 1)."' aria-label='Next'>
