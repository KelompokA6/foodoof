<html id="html" lang="en">
  ...
  <body>
    <div id="wrapper">
      ...
      <div id="users-online" class="btn btn-default col-md-2 col-no-padding text-left" style="position:fixed; left:0; bottom:0; z-index:100">
        ...
        <div class="col-md-12 col-no-padding" id="toggle-online-user">
