    ...
    <div class="col-md-6 col-xs-9 detail-list">
      ...
      <div class="col-md-12 col-xs-12 details">
          <div class="col-md-6 col-xs-3 col-no-padding-right">
            <a href="<?php echo base_url();?>user/timeline/{category_recipe_author_id}"><p class="text-capitalize">{category_recipe_author_name}</p></a>
          </div>
  ...
  <div class="col-md-12 col-xs-12 text-center">
    <?php
      if($category_recipe_page_size > 0){
        ...
        echo "'><a href='".base_url()."recipe/category/".urlencode($category_recipe_name)."&page=".($category_recipe_page_now - 1)."' aria-label='Previous'>
        ...
        for ($i=1; $i <= $category_recipe_page_size ; $i++) { 
          ...
          echo "
            <li class=".$active.">
              <a href='".base_url()."recipe/category/".urlencode($category_recipe_name)."&page=".$i."'>".$i."</a>
            </li>
          ";
        }
        ...
        echo "'><a href='".base_url()."recipe/category/".urlencode($category_recipe_name)."&page=".($category_recipe_page_now + 1)."' aria-label='Next'>
